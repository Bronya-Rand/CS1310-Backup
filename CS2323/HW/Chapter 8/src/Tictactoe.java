public class Tictactoe {
    ...
    private void checkWin(int playerID) {
        ...
        for (int i = 0; i < 3; i++) {
            if(board[i][0] == playerSymbol && board[i][1] == playerSymbol && board[i][2] == playerSymbol || board[0][i] == playerSymbol && board[1][i] == playerSymbol && board[2][i] == playerSymbol || board[0][0] == playerSymbol && board[1][1] == playerSymbol && board[2][2] == playerSymbol || board[0][2] == playerSymbol && board[1][1] == playerSymbol && board[2][0] == playerSymbol) {
                win = true;
            } 
        }
    }
