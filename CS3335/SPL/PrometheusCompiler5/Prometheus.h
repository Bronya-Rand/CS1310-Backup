...
//-----------------------------------------------------------
{
    ...
    strcat(this->sourceFileName, ".honkai"); // Former SPL extension
    strcpy(fullFileName, sourceFileName);
    strcat(fullFileName, ".aichan"); // Former List extension
...
//--------------------------------------------------
{
    ...
    strcat(codeFileName, ".hoyo"); // formerly STM 
